                ...
                <div className="products-view__options">
                    <div className={viewOptionsClasses}>
                        ...
                        <div className="view-options__legend">
                            {`Arata ${productsList.from}—${productsList.to} din ${productsList.total} produse`}
                        </div>
                        <div className="view-options__divider" />
                        <div className="view-options__control">
                            <label htmlFor="view-options-sort">Sorteaza Dupa</label>
                            <div>
                                <select
                        ...
                        <div className="view-options__control">
                            <label htmlFor="view-options-limit">Arata</label>
                            <div>
                                <select
