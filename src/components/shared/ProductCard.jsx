...
function ProductCard(props) {
    ...
    if (product.badges.includes('sale')) {
        badges.push(<div key="sale" className="product-card__badge product-card__badge--sale">Promotie</div>);
    }
    if (product.badges.includes('hot')) {
        badges.push(<div key="hot" className="product-card__badge product-card__badge--hot">Cautat</div>);
    }
    if (product.badges.includes('new')) {
        badges.push(<div key="new" className="product-card__badge product-card__badge--new">Nou</div>);
    }
        ...
        <div className={containerClasses}>
            ...
            <div className="product-card__info">
                ...
                <div className="product-card__rating">
                    ...
                    <div className=" product-card__rating-legend">{`${product.reviews} Recenzii`}</div>
                </div>
                {features}
            </div>
