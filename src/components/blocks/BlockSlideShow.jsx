...
class BlockSlideShow extends Component {
    ...
    slides = [
        {
            title: 'Debacterizare',
            text: 'Executăm debacterizarea <br/>prin curățarea tuturor componentelor',
            image_classic: {
        ...
        {
            title: 'Montaj',
            text: 'Asigurăm demontajul-montajul <br/> aparatelor de aer condiționat',
            image_classic: {
        ...
        {
            title: 'Verificare',
            text: 'Efectuăm verificarea aparatelor astfel <br/> încât să funcționeze în parametri',
            image_classic: {
                ...
                <div key={index} className="block-slideshow__slide">
                    ...
                    <div className="block-slideshow__slide-content">
                        ...
                        <div className="block-slideshow__slide-button">
                            <Link to="/" className="btn btn-primary btn-lg">Vezi acum</Link>
                        </div>
                    </div>
                </div>
            );
