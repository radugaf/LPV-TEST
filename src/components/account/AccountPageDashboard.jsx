        ...
        <div className="dashboard">
            ...
            <div className="dashboard__profile card profile-card">
                <div className="card-body profile-card__body">
                    ...
                    <div className="profile-card__name">Radu</div>
                    <div className="profile-card__email">Contact@lpvservice.ro</div>
                    <div className="profile-card__edit">
                        <Link to="profile" className="btn btn-secondary btn-sm">Editeaza Profil</Link>
                    </div>
                </div>
            </div>
            <div className="dashboard__address card address-card address-card--featured">
                {address.default && <div className="address-card__badge">Adresa</div>}
                <div className="address-card__body">
                    ...
                    <div className="address-card__footer">
                        <Link to="/account/addresses/5">Editeaza Adresa</Link>
                    </div>
                </div>
            </div>
            <div className="dashboard__orders card">
                <div className="card-header">
                    <h5>Comenzi Recente</h5>
                </div>
